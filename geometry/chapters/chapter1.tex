...
La clave está en observar un \emph{invariante}: una propiedad que se preserva bajo todas las reglas del sistema.
Contemos las letras $I$ en cada cadena y clasifiquémoslas según el \emph{residuo} al dividir entre 3. Por ejemplo: 1
