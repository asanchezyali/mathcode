...
\begin{itemize}
    \item \textbf{Estado inicial:} \texttt{MI} tiene una letra $I$ $\Rightarrow$ residuo 1.
    ...
    \item \textbf{Regla 3} (\texttt{III} $\to$ \texttt{U}): Elimina exactamente tres letras $I$ $\Rightarrow$ residuo sin
          cambio.
...
\begin{exercise}
    Demuestra que dos Fo's distintos tienen exactamente un Fe en común.
\end{exercise}
