...
\begin{exercise}
    ...
    \emph{Pista:} Usa el Axioma 3 para mostrar que un Fo no puede tener más de dos Fe's, y luego supón que tiene menos
    de dos para llegar a una contradicción usando los Axiomas 2 y 4.
\end{exercise}
...
\begin{exercise}
    ...
    \emph{Pista:} Supón que dos Fo's distintos contienen los mismos Fe's y encuentra una contradicción con el Axioma 2.
\end{exercise}

\begin{exercise}
    Demuestra que dos Fo's distintos contienen exactamente un Fe en común.

    \emph{Pista:} El Axioma 4 garantiza al menos uno. ¿Qué pasaría si tuvieran más de uno en común?
\end{exercise}

\begin{exercise}
    Demuestra que existen exactamente tres Fo's distintos.

    \emph{Pista:} Cada Fo tiene exactamente dos Fe's. ¿Cuántas formas hay de elegir 2 elementos de un conjunto de 3?
\end{exercise}