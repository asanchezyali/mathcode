...
\begin{definition}[Derivada de una función $f:\RR^m \to \RR$]. Una función $f:\RR^m \to \RR$ es diferenciable en $\pmb{x} \in \RR^m$ si las derivadas direccionales esta definidas en cualquier dirección, son lineales en cualquier dirección y se cumple que 
