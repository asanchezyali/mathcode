...
Para $x_0\in \RR$ y funciones $f,g:\RR \to \RR$ diferenciables en $x_0$, entonces:
\begin{itemize}
\item \textbf{Linealidad:} $(af + bg)'(x_0) = af'(x_0) + b g'(x_0)$, $a,b \in \RR$
\item \textbf{Regla del producto:} $(fg)'(x_0) = f'(x_0)g(x_0) + f(x_0)g'(x_0)$
\end{itemize}
...
\begin{align*}
    ...
    &= \big(f(x_0) + f'(x_0)h + o(h)\big)\big(g(x_0) + g'(x_0)h + o(h)\big) \\
...
\begin{itemize}
\item \textbf{Regla de la cadena:} $(f\circ g)'(x_0) = f'\big(g(x_0)\big)g'(x_0)$.
\end{itemize}
