...
%%% CODE QR BOXES
\definecolor{qrPythonBG}{RGB}{250, 245, 230}
\definecolor{qrPythonLabel}{RGB}{160, 130, 50}
\definecolor{qrCBG}{RGB}{233, 240, 250}
\definecolor{qrCLabel}{RGB}{50, 90, 150}
\definecolor{qrRustBG}{RGB}{248, 237, 233}
\definecolor{qrRustLabel}{RGB}{160, 70, 40}

\newcommand{\codeqrbox}[4]{%
    % #1 = bg color, #2 = label color, #3 = language label, #4 = url
    \begin{tcolorbox}[
        enhanced,
        colback=#1,
        colframe=#1,
        ...
        shadow={0pt}{-1pt}{2pt}{black!8},
    ]
        \centering
        \qrcode[height=2.2cm]{#4}\par\vspace{6pt}
        {\normalsize\bfseries\textcolor{#2}{#3}}
    \end{tcolorbox}%
}

\newcommand{\codeqrstrip}[6]{%
    % #1 = Python URL, #2 = C URL, #3 = Rust URL
    % #4 = Python filename, #5 = C filename, #6 = Rust filename
    \begin{center}
        \begin{minipage}[t]{0.28\textwidth}
            \codeqrbox{qrPythonBG}{qrPythonLabel}{Python}{#1}
        \end{minipage}\hfill
        \begin{minipage}[t]{0.28\textwidth}
            \codeqrbox{qrCBG}{qrCLabel}{C}{#2}
        \end{minipage}\hfill
        \begin{minipage}[t]{0.28\textwidth}
            \codeqrbox{qrRustBG}{qrRustLabel}{Rust}{#3}
        \end{minipage}
    \end{center}
}
