...
Las implementaciones completas del Algoritmo~\ref{alg:diferencias_finitas_vibratorio} están disponibles en el
repositorio del libro. Escanee los códigos QR para acceder al código fuente:
...
{finite\_differences\_vibration.py}
{finite\_differences\_vibration.c}
{finite\_differences\_vibration.rs}